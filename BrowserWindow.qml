    ...
    menuBar: ToolBar {
        ...
        RowLayout {
            ...
            TextField {
                ...
                onAccepted: currentWebView.url = browserUtils.fromUserInput(text)
                selectByMouse: true
            }
            ToolButton {
